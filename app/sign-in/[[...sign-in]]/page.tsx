...
const SignInPage = () => {
  return (
   ...
   <Image src="/Zync Logo on Black Background.png" alt="logo" width={500} height={500}></Image>
      </div>
      {/* form and custom clerk auth flow */}
          ...
          <SignIn.Step name="forgot-password">
            <div className="w-72 flex flex-col gap-4">
              ...
              <SignIn.SupportedStrategy name="reset_password_email_code">
                <SignIn.Action submit className="text-iconBlue underline">
                  Send reset code
                </SignIn.Action>
              </SignIn.SupportedStrategy>
              <SignIn.Action navigate="previous" className="underline text-sm">
                Go back
              </SignIn.Action>
            </div>
          </SignIn.Step>
          ...
          <SignIn.Step name="reset-password">
            <div className="w-72 flex flex-col gap-2">
              ...
              <Clerk.Field name="password">
                ...
                <Clerk.Input className="bg-white" />
                <Clerk.FieldError />
              </Clerk.Field>
